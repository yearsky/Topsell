...
<head>
	...
	<title>Sign In As Administrator - <?php echo e($config->name); ?></title>
	...
	<link href="<?php echo e(base_url()); ?>admin_assets/css/minified/bootstrap.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo e(base_url()); ?>admin_assets/css/minified/core.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo e(base_url()); ?>admin_assets/css/minified/components.min.css" rel="stylesheet" type="text/css">
	<link href="<?php echo e(base_url()); ?>admin_assets/css/minified/colors.min.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="<?php echo e(base_url()); ?>admin_assets/js/plugins/notifications/pnotify.min.js"></script>
	<script type="text/javascript" src="<?php echo e(base_url()); ?>admin_assets/js/plugins/notifications/noty.min.js"></script>
	<script type="text/javascript" src="<?php echo e(base_url()); ?>admin_assets/js/plugins/notifications/jgrowl.min.js"></script>
	<script type="text/javascript" src="<?php echo e(base_url()); ?>admin_assets/js/plugins/ui/prism.min.js"></script>
	...
	<script type="text/javascript" src="<?php echo e(base_url()); ?>admin_assets/js/pages/components_notifications_other.js"></script>
...
<body>
			...
			<div class="content-wrapper">
				...
				<div class="content">
						...
						<div class="panel login-form">
							<div class="panel-body bg-slate-800 ">
								...
								<div class="form-group has-feedback has-feedback-left">
									<input type="hidden" name="<?php echo e($ctrl->security->get_csrf_token_name()); ?>" value="<?php echo e($ctrl->security->get_csrf_hash()); ?>" />
					...
					<div class="footer text-muted">
						&copy; 2016. <a href="<?php echo e(base_url()); ?>"><?php echo e(ucwords($config->name)); ?></a> Dari <a href="<?php echo e(base_url()); ?>" target="_blank"> Pengembang</a>
					</div>
					<!-- /footer -->
	...
	<script type="text/javascript" src="<?php echo e(base_url()); ?>admin_assets/js/auth/auth.js"></script>
