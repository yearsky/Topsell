...
<div class="page-header">
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			<li><a href="<?php echo e(base_url('superuser/auth')); ?>"><i class="icon-user-tie position-left"></i> Administrator</a></li>
		...
		<div class="col-lg-12">
			<div class="panel panel-white">
				...
				<div class="col-md-12 clearfix" style="margin-top:10px;margin-bottom:10px;">
					<a href="<?php echo e(base_url('superuser/auth/create')); ?>" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-plus3"></i></b> Tambah Administrator Baru</a>
				</div>
				<table class="table table-striped media-library table-lg table-responsive">
                    ...
                    <tbody>
                    	<?php foreach($auth as $key => $result): ?>
                         <tr>
	                        ...
	                        <td style="width:300px;">
	                        	<a href="<?php echo e(base_url('superuser/auth/update/'.$result->id.'/'.seo($result->name))); ?>">
	                        		<b><?php echo e(ucwords(read_more($result->name,30))); ?></b>
	                        	</a><br>
	                        	<span class="text-size-mini">
	                        	Tanggal Di Buat : <?php echo e(tgl_indo($result->created_at)); ?>

	                        	</span>
	                        </td>
	                         <td  align="left">
	                        	<span class="text-size-mini">
	                        	Terakhir : <span class="text-info"><?php echo e(tgl_indo($result->lastlog)); ?></span>
	                        	</span><br>
	                        	<span class="text-size-small">
	                        		ip address : <span class=" text-info"><?php echo e($result->ipaddress); ?></span>
	                        	</span>
	                        </td>
	                        <td align="center">
	                        	<div class="checkbox checkbox-switch">
									<label>
										...
										data-off-color="danger" onchange="changeStatus(this)" data-id="<?php echo e($result->id); ?>"
										 <?php echo e((@$result->status=='active') ? 'checked' : ''); ?> >
									</label>
								</div>
	                        </td>	                      
	                        <td class="text-center">
	                           <div class="btn-group">
			                    	...
			                    	<ul class="dropdown-menu dropdown-menu-right">
										...
										data-url="<?php echo e(base_url('superuser/auth/delete/'.$result->id.'/'.seo($result->name))); ?>">
...
<script type="text/javascript">
	...
	function changeStatus(that){
		...
		$.ajax({
			url: "<?php echo e(base_url('superuser/auth/changestatus')); ?>",
			method: 	"POST",
