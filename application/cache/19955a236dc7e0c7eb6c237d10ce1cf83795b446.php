				...
				<div class="tab-content ">
					<div class="tab-pane active">
						<div  style="padding:20px;">
                			<form id="form-config" class="form-horizontal" action="<?php echo e(base_url('superuser/config/aboutsave')); ?>" method="post">
								<div class="form-group">
									<label class="col-lg-2 control-label">Nama Website <span class="text-danger"><b>*</b></span></label>
									<div class="col-lg-10">
										<input class="form-control" type="text" placeholder="Nama Website" name="name" value="<?php echo e($config->name); ?>" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<textarea  id="editor-full" rows="2"  name="description" cols="2"><?php echo $config->description; ?></textarea>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<textarea rows="4" cols="4" class="form-control"  name="address" placeholder="Alamat Disini"><?php echo e($config->address); ?></textarea>
										<input type="hidden" name="gmap" value="<?php echo e($config->gmap); ?>" required="">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<textarea  id="editor-full-2" rows="2"  name="opentime" cols="2"><?php echo $config->opentime; ?></textarea>
									</div>
								</div>
...
<script>
function initMap() {
  var latlng 	= {lat: Number('<?php echo e(goExplode($config->gmap,'&&',0)); ?>'), lng: Number('<?php echo e(goExplode($config->gmap,'&&',1)); ?>')};
  ...
  var marker = new google.maps.Marker({
    ...
    position: {lat: Number('<?php echo e(goExplode($config->gmap,'&&',0)); ?>'), lng: Number('<?php echo e(goExplode($config->gmap,'&&',1)); ?>')},
  });
