<?php $__env->startSection('title'); ?>
 Daftar Sub Menu Pengunjung - <?php echo e($config->name); ?>
...
<div class="page-header">
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			<li><a href="<?php echo e(base_url('superuser/submenupengunjung')); ?>"><i class="icon-stack2 position-left"></i> Sub Menu Pengunjung</a></li>
		...
		<div class="col-lg-12">
			<div class="panel panel-white">
				...
				<div class="col-md-12 clearfix" style="margin-top:10px;margin-bottom:10px;">
					<a href="<?php echo e(base_url('superuser/submenupengunjung/create')); ?>" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-plus3"></i></b> Tambah Sub Menu Pengunjung</a>
				</div>
				<table class="table table-striped media-library table-lg table-responsive">
                    ...
                    <tbody>
                    	<?php foreach($submenupengunjung as $key => $result): ?>
                         <tr>
                        	<td align="center"><?php echo e(($key+1)); ?></td>
	                        <td style="width:300px;">
	                        	<a href="#"><b><?php echo e($result->judul); ?></b></a><br>
	                        </td>
	                        <td align="center">
	                        	<span class="label label-default"><?php echo e($result->menupengunjung->judul); ?> </span>
	                        </td>
	                        <td align="center">
	                        ...
	                        <td class="text-center">
	                           <div class="btn-group">
			                    	...
			                    	<ul class="dropdown-menu dropdown-menu-right">
										<li>
											<a href="<?php echo e(base_url('superuser/submenupengunjung/update/'.$result->id.'/'.seo($result->judul))); ?>">
												<i class="fa fa-edit"></i> Ubah Sub Menu Pengunjung
											</a>
										</li>
										<li><a href="javascript:void(0)" onclick="deleteIt(this)" 
										data-url="<?php echo e(base_url('superuser/submenupengunjung/deleted/'.$result->id.'/'.seo($result->judul))); ?>">
