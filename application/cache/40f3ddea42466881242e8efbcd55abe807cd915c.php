...
<div class="page-header">
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			<li><a href="<?php echo e(base_url('superuser/seo')); ?>"><i class="icon-clipboard5 position-left"></i> SEO</a></li>
		...
		<div class="col-lg-12">
			<div class="panel panel-white">
				...
				<div class="col-md-12 clearfix" style="margin-top:10px;margin-bottom:10px;float:none;padding:20px;">
					<form id="form-blog" class="form-horizontal"  action="<?php echo e(base_url('superuser/seo/save')); ?>" method="post">
						<div class="form-group">
							...
							<div class="col-lg-10">
								...
								value="<?php echo e(@$seo->title); ?>" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								...
								value="<?php echo e(@$seo->author); ?>" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								...
								value="<?php echo e(@$seo->keyword); ?>" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<textarea rows="4" class="form-control" placeholder="Meta Description" name="description"><?php echo e(@$seo->description); ?></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<textarea rows="6" class="form-control" placeholder="Masukkan Kode Facebook Pixel Disini" name="fbpixel"><?php echo @$seo->fbpixel; ?></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<textarea rows="2" class="form-control" placeholder="Masukkan Kode Google analytics Disini" name="analytic"><?php echo @$seo->analytic; ?></textarea>
							</div>
						</div>
						<div class="form-group">
...
$('.file-input-custom').fileinput({
        ...
        initialPreview: ["<img src='<?php echo e($seo->imagedir); ?>' class='file-preview-image' alt=''>",],
	...
	$("#form-blog").submit(function(e){
			...
			.done(function(data){
				...
				function(){
					if(data.auth!=false){
						redirect("<?php echo e(base_url('superuser/seo')); ?>");		
						return;
					}
				});
