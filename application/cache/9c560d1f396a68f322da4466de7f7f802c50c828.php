		...
		<div class="col-lg-12">
			<div class="panel panel-white">
				...
				<div class="col-md-12 clearfix" style="margin-top:10px;margin-bottom:10px;">
					<a href="<?php echo e(base_url('superuser/sosmed/create')); ?>" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-plus3"></i></b> Tambah Sosial Media Baru</a>
				</div>
				<table class="table table-striped media-library table-lg table-responsive">
                    ...
                    <tbody>
                    	<?php foreach($sosmed as $key => $result): ?>
                         <tr>
                        	<td align="center"><?php echo e(($key+1)); ?></td>
	                        <td style="width:300px;">
	                        	<a href="<?php echo e(base_url('superuser/sosmed/update/'.$result->id.'/'.seo($result->name))); ?>">
	                        ...
	                        <td align="center">
	                        	<span class="label label-flat border-primary text-primary-600"><?php echo e($result->type); ?></span>
	                        </td>
	                        <td class="text-center">
	                           <div class="btn-group">
			                    	...
			                    	<ul class="dropdown-menu dropdown-menu-right">
										...
										data-url="<?php echo e(base_url('superuser/sosmed/delete/'.$result->id.'/'.seo($result->name))); ?>">
