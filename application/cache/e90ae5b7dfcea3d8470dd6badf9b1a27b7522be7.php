...
<div class="content">
	<h6 class="content-group text-semibold">
		<span class="text-primary"><i class="icon-magazine"></i> Daftar</span> Blog
		<small class="display-block">Ini merupakan daftar blog yang telah anda buat</i></small>
	</h6>
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-white">
				<div class="panel-heading">
					<h6 class="panel-title text-semibold">Daftar Blog Anda</h6>
				...
				<div class="col-md-12 clearfix" style="margin-top:10px;margin-bottom:10px;">
					<a href="<?php echo e(base_url('superuser/blog/create')); ?>" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-plus3"></i></b> Tambah Blog Baru</a>
				</div>
				<table class="table table-striped media-library table-lg table-responsive">
                    ...
                    <tbody>
                    	<?php foreach($blog as $key => $result): ?>
                         <tr>
	                        ...
	                        <td align="center">
	                        	<span class="label label-warning"><i class="fa fa-tags"></i> &nbsp;<?php echo e(read_more($result->category->name,20)); ?></span>
	                        </td>
	                        <td align="center">
			                    	...
			                    	<ul class="dropdown-menu dropdown-menu-right">
			                    		<li>
											<a href="<?php echo e($result->url); ?>" target="_blank">
												<i class="fa fa-eye"></i> Lihat Blog Website
											</a>
										</li>
										<li>
											<a href="<?php echo e($result->urlupdate); ?>">
												<i class="fa fa-edit"></i> Ubah Blog
											</a>
										</li>
