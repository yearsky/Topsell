		...
		<div class="col-lg-12">
			<div class="panel panel-white">
				...
				<div class="col-md-12 clearfix" style="margin-top:10px;margin-bottom:10px;">
					<a href="<?php echo e(base_url('superuser/gallery/create')); ?>" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-plus3"></i></b> Tambah Gallery Baru</a>
				</div>
				<table class="table table-striped media-library table-lg table-responsive">
                    ...
                    <tbody>
                    	<?php foreach($gallery as $key => $result): ?>
                         <tr>
	                        ...
	                        <td style="width:500px;">
	                        	<a href="<?php echo e($result->urlupdate); ?>">
	                        		<b><?php echo e(ucwords(read_more($result->name,100))); ?></b>
	                        	</a><br>
	                        	...
	                        	<span class="text-size-small text-muted">
	                        		<?php echo e(read_more($result->description,120)); ?>
