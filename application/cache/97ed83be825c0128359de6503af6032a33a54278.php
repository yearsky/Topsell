...
<div class="page-header">
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			<li><a href="<?php echo e(base_url('superuser/event')); ?>"><i class="icon-price-tag position-left"></i> Event</a></li>
		...
		<div class="col-lg-12">
			<div class="panel panel-white">
				...
				<div class="col-md-12 clearfix" style="margin-top:10px;margin-bottom:10px;">
					<a href="<?php echo e(base_url('superuser/event/create')); ?>" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-plus3"></i></b> Tambah Event Baru</a>
				</div>
				<table class="table table-striped media-library table-lg table-responsive">
                    ...
                    <tbody>
                    	<?php foreach($event as $key => $result): ?>
                         <tr>
