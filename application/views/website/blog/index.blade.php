		...
		<div class="col-lg-12">
			<div class="panel panel-white">
				...
				<div class="col-md-12 clearfix" style="margin-top:10px;margin-bottom:10px;">
					<a href="{{base_url('superuser/blog/create')}}" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-plus3"></i></b> Tambah Blog Baru</a>
				</div>
                    ...
                    <tbody>
                    	@foreach($blog as $key => $result)
                         <tr>
	                        ...
	                        <td align="center">
	                        	<span class="label label-warning"><i class="fa fa-tags"></i> &nbsp;{{read_more($result->category->name,20)}}</span>
	                        </td>
	                        <td align="center">
