...
<link rel="stylesheet" type="text/css" href="{{base_url('assets')}}/vendor/fontawesome/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="{{base_url('assets')}}/vendor/animateit/animate.min.css">
<link rel="stylesheet" type="text/css" href="{{base_url('assets')}}/vendor/owlcarousel/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="{{base_url('assets')}}/vendor/magnific-popup/magnific-popup.css">
<link rel="stylesheet" type="text/css" href="{{base_url('assets')}}/css/theme-base.css">
<link rel="stylesheet" type="text/css" href="{{base_url('assets')}}/css/theme-elements.css">
<link rel="stylesheet" type="text/css" href="{{base_url('assets')}}/css/responsive.css">
<link rel="stylesheet" type="text/css" href="{{base_url('assets')}}/css/color-variations/red.css" media="screen" title="red">
<link rel="stylesheet" type="text/css" href="{{base_url('assets')}}/css/google-fonts.css">
<link rel="stylesheet" type="text/css" href="{{base_url('assets')}}/vendor/rs-plugin/css/settings.css" media="all">
...
<script type="text/javascript" src="{{base_url('assets')}}/vendor/jquery/jquery-1.11.2.min.js"></script>
<script type="text/javascript" src="{{base_url('assets')}}/vendor/plugins-compressed.js"></script>
    ...
    <header id="header" class="header-light header-navigation-light header-fullwidth">
      <div id="header-wrap">
        <div class="container">
          <!-- TopSell Logo -->
          <div id="logo">
            <a href="{{base_url()}}"  class="logo" data-dark-logo="{{$config->logodir}}">
  ...
  <!-- BOTTOM PANEL : end -->
      ...
      <div class="footer-content">
        <div class="container">
          <div class="row">
            ...
            <li style="margin: 5px 2px;"><img src="{{base_url()}}images/website/pusat-grosir-5.png" style="height:21px;"> Total       : {{$total}} Orang</li>
    ...
    <div class="call-to-action">
      <ul>
        ...
        <li>
          <a href="https://api.whatsapp.com/send?phone={{$config->whatsapp}}&amp;text=Hallo">
        ...
        @if (!empty($config->bbm))
        <li>
          <a href="bbmi:{{$config->bbm}}" target="_blank">
        ...
        <li>
          <a href="mailto:{{$config->email}}?Subject=Hallo" target="_top">
            <i class="fa fa-envelope"></i>
            <span>Email</span>
          </a>
        </li>
        @endif    
        @if (!empty($config->gmap_query))
        <li>
          <a href="https://www.google.com/maps/embed/v1/place?key=AIzaSyBy_G0H8GDS521QaVAYPk_pinqKLqRdj3M&q={{$config->gmap_query}}" target="_blank">
...
<!-- JavaScript --> 
  ...
  <script type="text/javascript" src="{{base_url('assets')}}/js/theme-functions.js"></script>
