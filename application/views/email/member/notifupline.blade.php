...
@section('title')
 	Anda Mendapatkan Downline Baru !
@endsection
											...
											<table border="0" cellpadding="0" cellspacing="0" style="width: 90%;">
												<tr>
													<td align="left" class="textContent">
														...
														<a href="{{base_url('member/downliner')}}" style="margin-top:20px;margin-bottom:20px;font-size:14px;text-align:center;color:#fff;background:#8AD543;padding:20px;width:100%;display:block;" target="_blank">
