...
@section('title')
 	Konfirmasikan Pendaftaran Anda
@endsection

@section('description')
	Konfirmasi pendaftaran member anda
@endsection
											...
											<table border="0" cellpadding="0" cellspacing="0" width="210" style="max-width: 100%;">
												<tr>
													<td align="left" class="textContent">
														...
														<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:12px;margin-bottom:0;color:#FFF;line-height:135%;">Konfirmasi</div>
													</td>
												</tr>
											</table>
										</td>
											...
											<table border="0" cellpadding="0" cellspacing="0" style="width: 90%;">
												<tr>
													<td align="left" class="textContent">
														...
														<a href="{{$member->urlconfirmation}}" style="margin-top:20px;margin-bottom:20px;font-size:14px;text-align:center;color:#fff;background:#EA1E63;padding:20px;width:100%;display:block;" target="_blank">
															KONFIRMASI PENDAFTARAN
														</a>
													</td>
												</tr>
