...
@section('title')
 Konfirmasi Pendaftaran Reseller - {{$config->name}}
@endsection

@section('description')
	Konfirmasi Pendaftaran Akun Reseller Anda
@endsection

@section('header')
	Email Konfirmasi Pendaftaran Akun Reseller Anda
@endsection
											...
											<table class="flexibleContainerBoxNext" border="0" cellpadding="0" cellspacing="0" width="210" style="max-width: 100%;">
												<tr>
													<td align="left" class="textContent">
														...
														<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:12px;margin-bottom:0;color:#FFF;line-height:135%;">{{tgl_indo($reseller->created_at)}}</div>
													</td>
												</tr>
											</table>
										</td>
											...
											<table border="0" cellpadding="0" cellspacing="0" style="width: 90%;">
												<tr>
													<td align="left" class="textContent">
														...
														<a href="{{base_url('authentication/confirmation/reseller/'.$reseller->token)}}" style="margin-top:20px;margin-bottom:20px;font-size:14px;text-align:center;color:#fff;background:#1187DF;padding:20px;width:100%;display:block;" target="_blank">
														...
														<div style="margin-top:20px;margin-bottom:20px;font-size:12px;width:100%;text-align:center;border:1px dashed#ccc;padding:20px;color:#333;background:#eee">
															Manual Link : {{base_url('authentication/confirmation/reseller/'.$reseller->token)}}
														</div>
													</td>
												</tr>
											</table>
