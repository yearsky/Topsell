				...
				<div class="tab-content ">
					<div class="tab-pane active">
						<div  style="padding:20px;">
                			<form id="form-config" class="form-horizontal" action="{{base_url('superuser/config/contactsave')}}" method="post">
								<div class="form-group">
									<label class="col-lg-2 control-label">Email </label>
									<div class="col-lg-10">
										<input class="form-control" type="email" placeholder="Email Website" name="email" value="{{ $config->email }}" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input class="form-control" type="text" placeholder="No Telepon" name="phone" value="{{ $config->phone }}" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input class="form-control" type="text" placeholder="No Whatsapp" name="whatsapp" value="{{ $config->whatsapp }}" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input class="form-control" type="text" placeholder="Pin BBM" name="bbm" value="{{ $config->bbm }}" >
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<textarea  class="form-control" rows="2"  name="contact" cols="2">{{$config->contact}}</textarea>
									</div>
								</div>
...
$("#form-config").submit(function(e){
	...
	.done(function(data){
		...
		function(){
			if(data.auth!=false){
				redirect("{{base_url('superuser/config/contact')}}");		
				return;
			}
			return;
		});
