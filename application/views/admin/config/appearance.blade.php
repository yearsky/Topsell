				...
				<div class="tab-content ">
					<div class="tab-pane active">
						<div  style="padding:20px;">
                			<form id="form-config" class="form-horizontal" action="{{base_url('superuser/config/appearancesave')}}" method="post">
...
<script type="text/javascript">
    ...
    $("input[name=icon]").fileinput({
        ...
        initialPreview: ["<img src='{{$config->icondir}}' class='file-preview-image' alt=''>",],
    ...
    $("input[name=logo]").fileinput({
        ...
        initialPreview: ["<img src='{{$config->logodir}}' class='file-preview-image' alt=''>",],
        overwriteInitial: true,
    })
    ...
    $("input[name=logo_white]").fileinput({
        ...
        initialPreview: ["<img src='{{$config->logowhitedir}}' class='file-preview-image' alt=''>",],
        overwriteInitial: true,
    })
...
$("#form-config").submit(function(e){
	...
	.done(function(data){
		...
		function(){
			if(data.auth!=false){
				redirect("{{base_url('superuser/config/appearance')}}");		
				return;
			}
			return;
		});
