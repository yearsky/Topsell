		...
		<div class="col-lg-12">
			<div class="panel panel-white">
				...
				<div class="col-md-12 clearfix" style="margin-top:10px;margin-bottom:10px;">
					<a href="{{base_url('superuser/service/create')}}" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-plus3"></i></b> Tambah Service Baru</a>
				</div>
                         ...
                         <tr>
	                        ...
	                        <td style="width:300px;">
	                        	...
	                        	<span class="text-size-small text-muted">
	                        		{{read_more(strip_tags($result->description_sort),30)}}
	                        	</span>
	                        </td>
	                        <td align="center">
