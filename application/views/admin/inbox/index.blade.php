...
<div class="page-header">
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			<li><a href="{{base_url('superuser/inbox')}}"><i class="icon-envelop5 position-left"></i> Kotak Masuk</a></li>
		...
		<div class="col-lg-12">
			<div class="panel panel-white">
			    ...
			    <div class="col-md-12" style="margin-top:30px;margin-bottom:10px;">
			        <form id="bulkaction" method="post" action="{{base_url('superuser/inbox/action')}}">
			            <div class="col-xs-1">
			                <div class="checkbox">
			                    <label>
			        	...
			        	@foreach($inbox as $key => $result)
			             <tr class="{{($result->readed==0) ? 'active-ku' : ''}}">
			                ...
			                <td style="width:300px;">
			                	<a href="{{$result->url}}" class="text-readmore" >
			                	...
			                	<span class="text-size-mini">
			                		Tanggal Pesan : {{tgl_indo($result->created_at)}}
			                	</span>
			                </td>
			                <td align="center">
	                        	@if($result->respond==1)
	 ...
	 $("#bulkaction").submit(function(e){
			...
			if($("input[name='data[]']:checked").length <= 0 ){
				...
				function(){
					...
					$.ajax({
						url: "{{base_url('superuser/inbox/action')}}",
						method: 	"POST",
						data: data,
						beforeSend: function(){
					...
					.done(function(data){
						...
						function(){
							redirect("{{base_url('superuser/inbox')}}");		
							return;
						});
