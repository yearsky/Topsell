...
<div class="page-header">
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			<li><a href="{{base_url('superuser/categoryblog')}}"><i class="icon-price-tags position-left"></i> Kategori Blog</a></li>
			<li class="active">Daftar Kategori Blog</li>
		</ul>
	</div>
</div>
...
<div class="content">
	<h6 class="content-group text-semibold">
		<span class="text-primary"><i class="icon-price-tags"></i> Daftar</span> Kategori Blog
		...
		<div class="col-lg-12">
			<div class="panel panel-white">
				<div class="panel-heading">
					<h6 class="panel-title text-semibold">Daftar Kategori Blog Anda</h6>
				...
				<div class="col-md-12 clearfix" style="margin-top:10px;margin-bottom:10px;">
					<a href="{{base_url('superuser/categoryblog/create')}}" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="icon-plus3"></i></b> Tambah Kategori Blog Baru</a>
				</div>
                    ...
                    <tbody>
                    	@foreach($category as $key => $result)
                         <tr>
	                        ...
	                        <td align="center">
	                        	<span class="label label-warning"><i class="icon-magazine"></i> &nbsp;{{count($result->blog)}} Blog</span>
	                        </td>
			                    	...
			                    	<ul class="dropdown-menu dropdown-menu-right">
			                    		<li>
											<a href="{{$result->url}}" target="_blank">
												<i class="fa fa-eye"></i> Lihat Kategori Blog Website
											</a>
										</li>
										<li>
											<a href="{{$result->urlupdate}}">
