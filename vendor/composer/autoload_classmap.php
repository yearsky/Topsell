...
return array(
    'Aksa_pagination' => $baseDir . '/application/libraries/Aksa_pagination.php',
    'AuthModel' => $baseDir . '/application/models/AuthModel.php',
    'AuthRuleModel' => $baseDir . '/application/models/AuthRuleModel.php',
    'Blade' => $baseDir . '/application/libraries/Blade.php',
    'BlogModel' => $baseDir . '/application/models/BlogModel.php',
    'CareerModel' => $baseDir . '/application/models/CareerModel.php',
    'CategoryBlogModel' => $baseDir . '/application/models/CategoryBlogModel.php',
    'CategoryProductModel' => $baseDir . '/application/models/CategoryProductModel.php',
    'ConfigModel' => $baseDir . '/application/models/ConfigModel.php',
    'DefuseLib' => $baseDir . '/application/libraries/DefuseLib.php',
    ...
    'EventPromoModel' => $baseDir . '/application/models/EventPromoModel.php',
    'File_Iterator' => $vendorDir . '/phpunit/php-file-iterator/src/Iterator.php',
    'File_Iterator_Facade' => $vendorDir . '/phpunit/php-file-iterator/src/Facade.php',
    'File_Iterator_Factory' => $vendorDir . '/phpunit/php-file-iterator/src/Factory.php',
    'GalleryModel' => $baseDir . '/application/models/GalleryModel.php',
    'Grauth' => $baseDir . '/application/libraries/Grauth.php',
    'HalamanModel' => $baseDir . '/application/models/HalamanModel.php',
    'InboxModel' => $baseDir . '/application/models/InboxModel.php',
    'JobModel' => $baseDir . '/application/models/JobModel.php',
    'MY_Model' => $baseDir . '/application/core/MY_Model.php',
    'Magicmailer' => $baseDir . '/application/libraries/Magicmailer.php',
    'MenupengunjungModel' => $baseDir . '/application/models/MenupengunjungModel.php',
    'Middleware' => $baseDir . '/application/libraries/Middleware.php',
    ...
    'PartnershipModel' => $baseDir . '/application/models/PartnershipModel.php',
    'PricelistModel' => $baseDir . '/application/models/PricelistModel.php',
    'ProductImagesModel' => $baseDir . '/application/models/ProductImagesModel.php',
    'ProductModel' => $baseDir . '/application/models/ProductModel.php',
    'ProjectModel' => $baseDir . '/application/models/ProjectModel.php',
    'ProjectimgModel' => $baseDir . '/application/models/ProjectimgModel.php',
    ...
    'SeoModel' => $baseDir . '/application/models/SeoModel.php',
    'ServiceModel' => $baseDir . '/application/models/ServiceModel.php',
    'SliderModel' => $baseDir . '/application/models/SliderModel.php',
    'SosmedModel' => $baseDir . '/application/models/SosmedModel.php',
    'StatistikModel' => $baseDir . '/application/models/StatistikModel.php',
    'SubmenupengunjungModel' => $baseDir . '/application/models/SubmenupengunjungModel.php',
    'SubscribeModel' => $baseDir . '/application/models/SubscribeModel.php',
    'TagBlogModel' => $baseDir . '/application/models/TagBlogModel.php',
    'TagModel' => $baseDir . '/application/models/TagModel.php',
    'TestimoniModel' => $baseDir . '/application/models/TestimoniModel.php',
    'Text_Template' => $vendorDir . '/phpunit/php-text-template/src/Template.php',
    'Validation' => $baseDir . '/application/libraries/Validation.php',
