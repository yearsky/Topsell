...
class ComposerStaticInitf936d1601ec711e32cb22c498c7e4f1e
{
    ...
    public static $classMap = array (
        'Aksa_pagination' => __DIR__ . '/../..' . '/application/libraries/Aksa_pagination.php',
        'AuthModel' => __DIR__ . '/../..' . '/application/models/AuthModel.php',
        'AuthRuleModel' => __DIR__ . '/../..' . '/application/models/AuthRuleModel.php',
        'Blade' => __DIR__ . '/../..' . '/application/libraries/Blade.php',
        'BlogModel' => __DIR__ . '/../..' . '/application/models/BlogModel.php',
        'CareerModel' => __DIR__ . '/../..' . '/application/models/CareerModel.php',
        'CategoryBlogModel' => __DIR__ . '/../..' . '/application/models/CategoryBlogModel.php',
        'CategoryProductModel' => __DIR__ . '/../..' . '/application/models/CategoryProductModel.php',
        'ConfigModel' => __DIR__ . '/../..' . '/application/models/ConfigModel.php',
        'DefuseLib' => __DIR__ . '/../..' . '/application/libraries/DefuseLib.php',
        ...
        'EventPromoModel' => __DIR__ . '/../..' . '/application/models/EventPromoModel.php',
        'File_Iterator' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Iterator.php',
        'File_Iterator_Facade' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Facade.php',
        'File_Iterator_Factory' => __DIR__ . '/..' . '/phpunit/php-file-iterator/src/Factory.php',
        'GalleryModel' => __DIR__ . '/../..' . '/application/models/GalleryModel.php',
        'Grauth' => __DIR__ . '/../..' . '/application/libraries/Grauth.php',
        'HalamanModel' => __DIR__ . '/../..' . '/application/models/HalamanModel.php',
        'InboxModel' => __DIR__ . '/../..' . '/application/models/InboxModel.php',
        'JobModel' => __DIR__ . '/../..' . '/application/models/JobModel.php',
        'MY_Model' => __DIR__ . '/../..' . '/application/core/MY_Model.php',
        'Magicmailer' => __DIR__ . '/../..' . '/application/libraries/Magicmailer.php',
        'MenupengunjungModel' => __DIR__ . '/../..' . '/application/models/MenupengunjungModel.php',
        'Middleware' => __DIR__ . '/../..' . '/application/libraries/Middleware.php',
        ...
        'PartnershipModel' => __DIR__ . '/../..' . '/application/models/PartnershipModel.php',
        'PricelistModel' => __DIR__ . '/../..' . '/application/models/PricelistModel.php',
        'ProductImagesModel' => __DIR__ . '/../..' . '/application/models/ProductImagesModel.php',
        'ProductModel' => __DIR__ . '/../..' . '/application/models/ProductModel.php',
        'ProjectModel' => __DIR__ . '/../..' . '/application/models/ProjectModel.php',
        'ProjectimgModel' => __DIR__ . '/../..' . '/application/models/ProjectimgModel.php',
        ...
        'SeoModel' => __DIR__ . '/../..' . '/application/models/SeoModel.php',
        'ServiceModel' => __DIR__ . '/../..' . '/application/models/ServiceModel.php',
        'SliderModel' => __DIR__ . '/../..' . '/application/models/SliderModel.php',
        'SosmedModel' => __DIR__ . '/../..' . '/application/models/SosmedModel.php',
        'StatistikModel' => __DIR__ . '/../..' . '/application/models/StatistikModel.php',
        'SubmenupengunjungModel' => __DIR__ . '/../..' . '/application/models/SubmenupengunjungModel.php',
        'SubscribeModel' => __DIR__ . '/../..' . '/application/models/SubscribeModel.php',
        'TagBlogModel' => __DIR__ . '/../..' . '/application/models/TagBlogModel.php',
        'TagModel' => __DIR__ . '/../..' . '/application/models/TagModel.php',
        'TestimoniModel' => __DIR__ . '/../..' . '/application/models/TestimoniModel.php',
        'Text_Template' => __DIR__ . '/..' . '/phpunit/php-text-template/src/Template.php',
        'Validation' => __DIR__ . '/../..' . '/application/libraries/Validation.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitf936d1601ec711e32cb22c498c7e4f1e::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitf936d1601ec711e32cb22c498c7e4f1e::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInitf936d1601ec711e32cb22c498c7e4f1e::$prefixesPsr0;
            $loader->classMap = ComposerStaticInitf936d1601ec711e32cb22c498c7e4f1e::$classMap;
